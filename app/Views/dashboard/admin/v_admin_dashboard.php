    ...
    <div class="col-sm-9">
        <div class="panel no-border">
            <div class="panel-heading">
                <span class="font-bold">Grafik Keuangan</span>
                <small class="block text-muted">Pemasukan dan Pengeluaran YPBK</small>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
                <table class="table table-striped m-b-none">
                    ...
                    <tbody>
                        <?php
                        foreach ($historis_pendapatan as $key => $value) { ?>
                            ...
                            <tr>
                                ...
                                <script>
                                    var Now = moment($value['tgl_transaksi'], "MM/DD/YYYY").fromNow();
                        ...
                        <tbody>
                            ...
                            foreach ($historis as $key => $value) { ?>
                                ...
                                <tr>
                                    ...
                                    <script>
                                        var Now = moment($value['tgl_bayar'], "MM/DD/YYYY").fromNow();
                                        var x = document.getElementById('tgl');
                                        x.innerHTML = Now;
                                    </script>
