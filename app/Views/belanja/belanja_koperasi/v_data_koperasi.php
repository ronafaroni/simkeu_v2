    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pengeluaran Anggaran Koperasi</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/belanja_koperasi" method="post" class="form-validate is-alter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <select class="form-select form-control form-control-lg" name="kategori_belanja" data-search="on">
                                <option value="">Kode Belanja</option>
                                <option value="SDUT">Belanja Koperasi SDUT</option>
                                <option value="TPQ">Belanja Koperasi TPQ</option>
                                <option value="SMPUT">Belanja Koperasi SMPUT</option>
                                <option value="IBS">Belanja Koperasi Boarding</option>
                                <option value="PAUD">Belanja Koperasi PAUD</option>
                            </select>
                        </div>
                    </div>
...
<div class="card-heading">
    <h2>5.1.5.2 <?php echo $menu; ?></h2>
    <small>Data belanja koperasi.</small>
</div>
                            ...
                            if (!empty($koperasi)) {
                                ...
                                foreach ($koperasi as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus_koperasi/' . $value['id_belanja']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><em class=" icon ni ni-trash"></em><span><i class="fa fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
