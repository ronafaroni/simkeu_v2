    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pengeluaran Anggaran SBS</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/belanja_sbs" method="post" class="form-validate is-alter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <select class="form-select form-control form-control-lg" name="jenis_mobil" data-search="on">
                                <option value="">Jenis Kendaraan</option>
                                <option value="SBS">Kendaraan SBS</option>
                                <option value="WULING">Kendaraan Wuling</option>
                            </select>
                        </div>
                    </div>
...
<div class="card-heading">
    <h2>5.1.5.3 <?php echo $menu; ?></h2>
    <small>Data belanja transportasi SBS.</small>
</div>
                            ...
                            if (!empty($sbs)) {
                                ...
                                foreach ($sbs as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus_sbs/' . $value['id_belanja']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><em class=" icon ni ni-trash"></em><span><i class="fa fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
