    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/belanja_sekolah" method="post" class="form-validate is-alter">
                            ...
                            if (!empty($sekolah)) {
                                ...
                                foreach ($sekolah as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus_sekolah/' . $value['id_belanja']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><em class=" icon ni ni-trash"></em><span><i class="fa fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
