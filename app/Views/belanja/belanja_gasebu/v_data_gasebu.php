    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Transaksi Pengeluaran Gasebu</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/belanja_gasebu" method="post" class="form-validate is-alter">
...
<div class="card-heading">
    <h2>5.1.5.5 <?php echo $menu; ?></h2>
    <small>Data pengeluaran belanja gasebu.</small>
</div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div align="left">
                    <a data-toggle="modal" data-target="#modalGasebu" class="btn btn-addon btn-warning waves-effect"><i class="fa fa-plus"></i> Pengeluaran Anggaran</a>
                            ...
                            if (!empty($gasebu)) {
                                ...
                                foreach ($gasebu as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus_gasebu/' . $value['id_belanja']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><em class=" icon ni ni-trash"></em><span><i class="fa fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
