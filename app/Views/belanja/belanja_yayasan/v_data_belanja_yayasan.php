    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/pengeluaran_yayasan" method="post" class="form-validate is-alter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" name="kode_transaksi" class="form-control" id="full-name" autocomplete="off" placeholder="Kode 5.1.2 | Belanja Kegiatan Yayasan" disabled>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="card-heading">
    <h2>5.1.2 <?php echo $menu; ?></h2>
    <small>Data pengeluaran belanja yayasan.</small>
</div>
                            ...
                            if (!empty($yayasan)) {
                                ...
                                foreach ($yayasan as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus_yayasan/' . $value['id_belanja']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><em class=" icon ni ni-trash"></em><span><i class="fa fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
