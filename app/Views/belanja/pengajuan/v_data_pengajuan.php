    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pengajuan Anggaran</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/pengajuan_anggaran" method="post" class="form-validate is-alter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <select class="form-select form-control form-control-lg" name="kode_unit" data-search="on">
                                <option value="">Kode Unit</option>
                                <option value="5.2">5.2 - Belanja SDUT</option>
                                <option value="5.3">5.3 - Belanja TPQ</option>
                                <option value="5.4">5.4 - Belanja SMPUT</option>
                                <option value="5.5">5.5 - Belanja IBS</option>
                                <option value="5.6">5.6 - Belanja PAUD</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="phone-no">Tgl. Pengajuan</label>
                        <div class="form-control-wrap">
                            <input type="text" name="tgl_pengajuan" class="form-control date-picker" id="phone-no" autocomplete="off" placeholder="Tgl. Pengajuan">
                        </div>
                    </div>

                    <input type="hidden" name="teller" class="form-control" id="phone-no" autocomplete="off" value="RN">
...
<div class="card-heading">
    <h2><?php echo $menu; ?></h2>
    <small>Data antrian pengajuan anggaran.</small>
</div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div align="left">
                    <a data-toggle="modal" data-target="#modalHarian" class="btn btn-addon btn-warning waves-effect"><i class="fa fa-plus"></i> Pengeluaran Anggaran</a>
                            ...
                            if (!empty($pengajuan)) {
                                ...
                                foreach ($pengajuan as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus_pengajuan/' . $value['id_pengajuan']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><em class=" icon ni ni-trash"></em><span><i class="fa fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
