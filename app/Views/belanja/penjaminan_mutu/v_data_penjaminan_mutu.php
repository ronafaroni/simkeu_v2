    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Transaksi Pengeluaran</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/pengeluaran_mutu" method="post" class="form-validate is-alter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" name="kode_transaksi" class="form-control" id="full-name" autocomplete="off" placeholder="Kode 5.1.1 | Belanja Penjaminan Mutu" disabled>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="card-heading">
    <h2>5.1.1 <?php echo $menu; ?></h2>
    <small>Data pengeluaran belanja penjaminan mutu.</small>
</div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div align="left">
                    <a data-toggle="modal" data-target="#modalPenjaminanMutu" class="btn btn-addon btn-info waves-effect"><i class="fa fa-plus"></i> Tambah Pengeluaran</a>
                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            if (!empty($penjaminan_mutu)) {
                                $no = 1;
                                foreach ($penjaminan_mutu as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus/' . $value['id_belanja']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><span><i class="fa fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
