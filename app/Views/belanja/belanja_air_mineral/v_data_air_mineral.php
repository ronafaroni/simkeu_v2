    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pengeluaran Anggaran Air Mineral</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>/belanja/belanja_air_mineral" method="post" class="form-validate is-alter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <select class="form-select form-control form-control-lg" name="jenis_belanja" data-search="on">
                                ...
                                <option value="Honorarium Tenaga">Honorarium Tenaga</option>
                            </select>
                        </div>
                    </div>
...
<div class="card-heading">
    <h2>5.1.5.4 <?php echo $menu; ?></h2>
    <small>Data belanja air mineral.</small>
</div>
                            ...
                            if (!empty($air_mineral)) {
                                ...
                                foreach ($air_mineral as $key => $value) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-xs" href="<?= base_url('belanja/hapus_air_mineral/' . $value['id_belanja']) ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ??')"><em class=" icon ni ni-trash"></em><span><i class="fa  fa-trash"></i> Hapus Data</span></a>
                                        </td>
                                    </tr>
