    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="card-heading">
                <h2>Data Pembayaran Pembayaran</h2>
                <small>Data pembayaran siswa.</small>
            </div>
            ...
            <div class="panel-body">
                ...
                <form action="<?= base_url('tagihan/cek_data_pembayaran'); ?>" method="post" enctype="multipart/form-data">
