...
<script src="<?= base_url() ?>/public/dashboard/assets/plugins/common/common.min.js"></script>
<script src="<?= base_url() ?>/public/dashboard/main/js/custom.min.js"></script>
<script src="<?= base_url() ?>/public/dashboard/main/js/js/settings.js"></script>
<script src="<?= base_url() ?>/public/dashboard/main/js/js/gleek.js"></script>
<script src="<?= base_url() ?>/public/dashboard/main/js/js/styleSwitcher.js"></script>
<!-- Morris Chart -->
<script src="<?= base_url() ?>/public/dashboard/assets/plugins/raphael/raphael.min.js"></script>
<script src="<?= base_url() ?>/public/dashboard/assets/plugins/morris/morris.min.js"></script>

<script src="<?= base_url() ?>/public/dashboard/assets/plugins/chart.js/Chart.bundle.min.js"></script>

<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDVwc4veKudU0qjYrLrrQXacCkDkcy3AeQ"></script>
<script src="<?= base_url() ?>/public/dashboard/assets/plugins/gmaps/gmaps.min.js"></script>

<script src="<?= base_url() ?>/public/dashboard/main/js/dashboard/dashboard-8.js"></script>
