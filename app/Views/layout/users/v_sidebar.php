                      ...
                      <div class="box-inner">
                          <div class="list-group no-radius no-borders">
                              <a data-toggle="modal" data-target="#chat" data-dismiss="modal" class="list-group-item p-h-md">
                                  <img src="<?= base_url() ?>/public/template/images/a1.jpg" class="pull-left w-40 m-r img-circle">
                                  <div class="clear">
                              ...
                              <a data-toggle="modal" data-target="#chat" data-dismiss="modal" class="list-group-item p-h-md">
                                  <img src="<?= base_url() ?>/public/template/images/a2.jpg" class="pull-left w-40 m-r img-circle">
                                  <div class="clear">
  ...
  <div class="modal fade" id="chat" data-backdrop="false">
      <div class="right w-xxl bg-white md-whiteframe-z2">
          <div class="box">
              ...
              <div class="box-row bg-light lt">
                  <div class="box-cell">
                      <div class="box-inner">
                          <div class="p-md">
                              <div class="m-b">
                                  <a href class="pull-left w-40 m-r-sm"><img src="<?= base_url() ?>/public/template/images/a2.jpg" alt="..." class="w-full img-circle"></a>
                                  <div class="clear">
                              ...
                              <div class="m-b">
                                  <a href class="pull-right w-40 m-l-sm"><img src="<?= base_url() ?>/public/template/images/a3.jpg" class="w-full img-circle" alt="..."></a>
              ...
              <div class="p-h-md p-v">
                  <a class="pull-left w-32 m-r"><img src="<?= base_url() ?>/public/template/images/a3.jpg" class="w-full img-circle" alt="..."></a>
                  <form>
